...
function Home() {
  ...
  const sendEmail = (e) => {
    ...
    e.preventDefault();
    emailjs.sendForm('service_hi53e1d', 'template_81il5rr', form.current, 'DQxxUF8LJ8OPbaqr0')
      .then((result) => {
        ...
        <Container>
          ...
          <Row className="align-items-center">
            <Col md={6} sm={12} className="wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              <div>
                <p><span>Email:</span> waleedsalah1779@gmail.com</p>
                <p><span>Phone:</span> 01201834720</p>
                <p><span>Address:</span> victoria alexandria </p>
              </div>
            </Col>
